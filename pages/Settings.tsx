    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="flex flex-col items-center gap-4">
               <img src={formData.avatar} alt="Avatar" className="w-32 h-32 rounded-full object-cover border-4 border-slate-50 shadow-sm" />
        ...
        <div className="flex justify-end pt-4">
           <button 
              onClick={handleSave}
              className="flex items-center gap-2 rounded-lg bg-primary px-6 py-2.5 text-sm font-bold text-white shadow hover:bg-sky-600 transition-colors"
           >
             <Save size={18} />
             Simpan Perubahan
           </button>
